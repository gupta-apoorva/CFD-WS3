...
void boundaryvalues(int imax,int jmax,int wl, int wr, int wt, int wb, double **U,double **V, double** P, double** G, double** F, int** FLAG, const char* problem, int delta_p)
{
